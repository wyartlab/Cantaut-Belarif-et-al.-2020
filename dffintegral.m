...
%     vpeaks = findpeaks_JRS([1:nframes], adj_v(i,:), 0.02, 0.1, 3, 3, 2); % adjust params here for peak detection
% end
% 
% for i=length(adj_d(:,1));
%     dpeaks = findpeaks_JRS([1:nframes], adj_d(i,:), 0.02, 0.1, 3, 3, 2); % adjust params here for peak detection
% end
